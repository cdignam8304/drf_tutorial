...
#    # path("user/<int:pk>/", views.UseraDetail.as_view(), name="user-detail"), # tut5
...
# tut 6b
# Implment DefaultRouter to auto-generate API root view and url config for other views
# ------------------------------------------------------------------------------------
...
# tut6 -> format suffix patterns are added by router. Adding them here (thereby duplicating) throws an error.
